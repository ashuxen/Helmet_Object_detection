...
class Streamlit_YOLOV7(SingleInference_YOLOV7):
    ...
    def main(self):
        ...
        self.load_image_st()
        predictions = st.button('Predict Objects on the image?')
        if predictions:
            self.predict()
            predictions = False
...
if __name__ == '__main__':
    ...
    path_img_i = "https://raw.githubusercontent.com/ashuxen/Helmet_Object_detection/main/test_images/hard_hat_workers1294.png"
    # INPUTS for webapp
